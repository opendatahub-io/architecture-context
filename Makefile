.PHONY: build build-arch-query build-arch-analyzer build-arch-doc build-embedded test test-python test-arch-query test-arch-analyzer test-arch-doc clean lint lint-python lint-go lint-overlays lint-platforms lint-architecture-docs

build: build-arch-query build-arch-analyzer build-arch-doc
...
build-arch-doc:
	$(MAKE) -C src/arch-doc build

build-embedded:
	$(MAKE) -C src/arch-query build-embedded

test: test-python test-arch-query test-arch-analyzer test-arch-doc
