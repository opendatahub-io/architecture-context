...
class TestActiveQuestions:
    def test_active_count_is_33(self, manifest):
...
class TestRetiredQuestions:
    def test_retired_count_is_7(self, manifest):
...
class TestConsumerV1Compatibility:
    ...
    def test_consumer_v1_corpus_has_33_questions(self, consumer_v1_corpus):
        assert len(consumer_v1_corpus["questions"]) == 33
