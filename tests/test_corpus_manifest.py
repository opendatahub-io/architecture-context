...
class TestActiveQuestions:
    def test_active_count_is_37(self, manifest):
...
class TestRetiredQuestions:
    def test_retired_count_is_3(self, manifest):
...
class TestConsumerV1Compatibility:
    ...
    def test_consumer_v1_corpus_has_37_questions(self, consumer_v1_corpus):
        assert len(consumer_v1_corpus["questions"]) == 37
