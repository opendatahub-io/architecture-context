...
- **crds (observed)**: 22 crds facts extracted [source: api/cloudmanager/aws/v1alpha1/awskubernetesengine_types.go:55, api/cloudmanager/azure/v1alpha1/azurekubernetesengine_types.go:55, api/cloudmanager/coreweave/v1alpha1/coreweavekubernetesengine_types.go:55, api/components/v1alpha1/datasciencepipelines_types.go:45, api/components/v1alpha1/kueue_types.go:45, api/components/v1alpha1/modelregistry_types.go:64, api/components/v1alpha1/ray_types.go:44, api/components/v1alpha1/sparkoperator_types.go:51, api/components/v1alpha1/trainer_types.go:44, api/components/v1alpha1/trainingoperator_types.go:44, api/components/v1alpha1/trustyai_types.go:44, api/config/v1alpha1/platform_types.go:92, api/datasciencecluster/v1/datasciencecluster_types.go:182, api/datasciencecluster/v2/datasciencecluster_types.go:182, api/dscinitialization/v1/dscinitialization_types.go:92, api/dscinitialization/v2/dscinitialization_types.go:85, api/features/v1/features_types.go:18, api/infrastructure/v1/hardwareprofile_types.go:134, api/infrastructure/v1alpha1/hardwareprofile_types.go:134, api/services/v1alpha1/auth_types.go:57, api/services/v1alpha1/gateway_types.go:198, api/services/v1alpha1/monitoring_types.go:155]
- **grpc_services (confirmed-empty)**: 0 grpc_services facts extracted
- **http_endpoints (observed)**: 4 http_endpoints facts extracted [source: cmd/cloudmanager/app/run.go:81, cmd/cloudmanager/app/run.go:85, cmd/main.go:588, cmd/main.go:592]
...
- **controller**: ServiceHandler —watches-reference→ rbac.authorization.k8s.io/v1/RoleBinding; rbac.authorization.k8s.io/v1/RoleBinding [source: internal/controller/services/auth/auth_controller.go:62, pkg/cluster/resources.go:248]
- **controller**: componentHandler —watches-reference→ /v1/ConfigMap; /v1/ConfigMap [source: internal/controller/components/datasciencepipelines/datasciencepipelines_controller.go:47, internal/controller/components/kueue/kueue_config.go:62]
...
- **controller**: componentHandler —watches-reference→ rbac.authorization.k8s.io/v1/RoleBinding; rbac.authorization.k8s.io/v1/RoleBinding [source: internal/controller/components/datasciencepipelines/datasciencepipelines_controller.go:52, pkg/cluster/resources.go:248]
- **controller**: serviceHandler —watches-reference→ /v1/ConfigMap; /v1/ConfigMap [source: internal/controller/components/kueue/kueue_config.go:62, internal/controller/services/monitoring/monitoring_controller.go:97]
...
- **controller**: serviceHandler —watches-reference→ rbac.authorization.k8s.io/v1/RoleBinding; rbac.authorization.k8s.io/v1/RoleBinding [source: internal/controller/services/monitoring/monitoring_controller.go:91, pkg/cluster/resources.go:248]
...
- **Question:** Where is authentication enforced for this surface, and is it conditional?
  **Expected signal:** middleware, filter, policy, or enforcement branch
  **Candidate:** `cmd/main.go`:477 (TLS serving certificate (server identity), Webhook (port 9443))
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
- **Question:** Where is authentication enforced for this surface, and is it conditional?
  **Expected signal:** middleware, filter, policy, or enforcement branch
...
- **Question:** What lifecycle, command, probes, and deployment configuration surround this entrypoint?
  ...
  **Candidate:** `Dockerfiles/Dockerfile`:84 (Dockerfiles/Dockerfile:ENTRYPOINT)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
- **Question:** What lifecycle, command, probes, and deployment configuration surround this entrypoint?
  **Expected signal:** main command, startup path, probe, signal handling, or workload mapping
...
- **Question:** What target, credentials, TLS settings, and failure behavior does this client use?
  ...
  **Candidate:** `pkg/controller/reconciler/reconciler.go`:134 (Kubernetes API, client-go discovery client)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
### http_endpoints
...
- **Question:** Does this endpoint have additional dynamic routes or a concrete handler/owner?
  **Expected signal:** route registration, handler binding, middleware, or owner symbol
  **Candidate:** `cmd/main.go`:588 (/healthz, GET, cmd)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
...
- **Question:** What source-backed runtime behavior uses this component reference?
  ...
  **Candidate:** `internal/controller/components/kueue/kueue_config.go`:62 (/v1/ConfigMap, create, delete, get, list, update operations by DSCInitializationReconciler, GateChecker)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
- **Question:** Where is this internal dependency invoked and what is the interaction boundary?
  **Expected signal:** import, client call, queue, or controller handoff
...
- **Question:** What source-backed runtime behavior uses this component reference?
  **Expected signal:** client, API, watch, or configuration handoff
  **Candidate:** `internal/controller/services/gateway/gateway_controller_actions.go`:291 (/v1/Secret, create, get, list, update operations by BaseServingConnectionWebhook)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
- **Question:** What source-backed runtime behavior uses this component reference?
  **Expected signal:** client, API, watch, or configuration handoff
  **Candidate:** `internal/controller/services/gateway/gateway_support.go`:665 (/v1/Service, get, list operations)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
- **Question:** What source-backed runtime behavior uses this component reference?
  **Expected signal:** client, API, watch, or configuration handoff
...
- **Question:** What source-backed runtime behavior uses this component reference?
  **Expected signal:** client, API, watch, or configuration handoff
  **Candidate:** `pkg/clusterhealth/quotas.go`:47 (/v1/ResourceQuota, list operations)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
- **Question:** Where is this internal dependency invoked and what is the interaction boundary?
  **Expected signal:** import, client call, queue, or controller handoff
...
- **Question:** What source-backed runtime behavior uses this component reference?
  **Expected signal:** client, API, watch, or configuration handoff
  **Candidate:** `pkg/webhook/utils.go`:113 (/v1/ServiceAccount, create, list operations)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
...
- **Question:** Which client/resource relationship implements this controller watch, and under what condition?
  **Expected signal:** watch registration, GVK, resource operations, or conditional branch
  **Candidate:** `internal/controller/components/trainer/trainer_controller.go`:50 (/v1/ConfigMap, componentHandler)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
- **Question:** Which client/resource relationship implements this controller watch, and under what condition?
  **Expected signal:** watch registration, GVK, resource operations, or conditional branch
...
- **Question:** Which client/resource relationship implements this controller watch, and under what condition?
  **Expected signal:** watch registration, GVK, resource operations, or conditional branch
  **Candidate:** `internal/controller/modules/modules_controller.go`:111 (/v1/ConfigMap)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
- **Question:** Which client/resource relationship implements this controller watch, and under what condition?
  **Expected signal:** watch registration, GVK, resource operations, or conditional branch
...
- **Question:** Which workload owns this Service and does its target port match a runtime listener?
  ...
  **Candidate:** `config/rbac/auth_proxy_service.yaml`:1 (opendatahub-operator-controller-manager, opendatahub-operator-controller-manager-metrics-service)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
- **Question:** Which workload owns this Service and does its target port match a runtime listener?
  **Expected signal:** selector, target deployment, port mapping, or listener
...
- Webhook (port 9443) methods=HTTPS mechanism=TLS serving certificate (server identity) enforcement=controller-runtime webhook server policy=API server validates the OpenShift service-ca serving certificate opendatahub-operator-controller-webhook-cert [source: cmd/main.go:477]
### http_endpoints

- GET /healthz on port ; transport=HTTP/1.1 encryption= auth= owner=cmd [source: cmd/main.go:588]
- GET /healthz on port ; transport=HTTP/1.1 encryption= auth= owner=cmd/cloudmanager/app [source: cmd/cloudmanager/app/run.go:81]
- GET /readyz on port ; transport=HTTP/1.1 encryption= auth= owner=cmd [source: cmd/main.go:592]
...
- opendatahub-operator-controller-manager-metrics-service port=8443 target=8080 protocol=TCP encryption= auth= [source: config/rbac/auth_proxy_service.yaml:1]
...
- **observed**: Service opendatahub-operator-controller-manager-metrics-service targets opendatahub-operator-controller-manager with 1 port(s) [source: config/rbac/auth_proxy_service.yaml:1]
...
- **observed**: HTTP GET /healthz is owned by cmd [source: cmd/main.go:588]
- **observed**: HTTP GET /healthz is owned by cmd/cloudmanager/app [source: cmd/cloudmanager/app/run.go:81]
- **observed**: HTTP GET /readyz is owned by cmd [source: cmd/main.go:592]
...
- **observed**: HTTPS Webhook (port 9443) uses TLS serving certificate (server identity) at controller-runtime webhook server; policy=API server validates the OpenShift service-ca serving certificate opendatahub-operator-controller-webhook-cert [source: cmd/main.go:477]
