...
- **Prometheus:** Inbound scrape; role: metrics-target; protocol: HTTP; purpose: Metrics collection via prometheus.io/scrape annotation at /q/metrics on port 8080. [source: explainability-service/manifests/base/trustyai-deployment.yaml:9-11, 35-37]
- **KServe/ModelMesh (REST):** Inbound payload consumer; role: data-source; protocol: HTTP; purpose: Receives ModelMesh inference partial payloads at /consumer/kserve/v2 for input/output reconciliation. [source: explainability-service/src/main/java/org/kie/trustyai/service/endpoints/consumer/ConsumerEndpoint.java:29-31]
- **KServe (CloudEvents):** Inbound event consumer; role: data-source; protocol: CloudEvents/HTTP; purpose: Consumes KServe inference request and response CloudEvents via Knative Funqy for KServe-native payload reconciliation. [source: explainability-service/src/main/java/org/kie/trustyai/service/endpoints/consumer/CloudEventConsumer.java:34-36]
