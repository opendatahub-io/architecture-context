...
| /metrics | Unknown | 9090 | HTTP | HTTP/1.1 | Unknown | Unknown | cmd/epp/runner | Prometheus metrics endpoint |
...
|-------|----|--------|---------|----------|----|-----|-------|
| ExternalProcessor | 9002 | gRPC | HTTP/2 | Optional TLS | None | pkg/epp/server | Envoy External Processor gRPC service for inference request routing |
| Health | 9003 | gRPC | HTTP/2 | Optional TLS | None | pkg/epp/server | gRPC health check service for liveness and readiness probes |
