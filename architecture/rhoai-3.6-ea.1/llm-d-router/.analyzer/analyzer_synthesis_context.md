...
- **grpc_services (observed)**: 2 grpc_services facts extracted [source: pkg/epp/server/runserver.go:231, pkg/epp/server/runserver.go:235]
- **http_endpoints (observed)**: 4 http_endpoints facts extracted [source: cmd/epp/runner/runner.go:1112, pkg/coordinator/server/server.go:115, pkg/coordinator/server/server.go:116, pkg/sidecar/proxy/proxy.go:539]
...
- **Question:** Where is authentication enforced for this surface, and is it conditional?
  ...
  **Candidate:** `pkg/epp/server/runserver.go`:231 (External Processor gRPC, None)
...
- **Question:** What target, credentials, TLS settings, and failure behavior does this client use?
  ...
  **Candidate:** `pkg/common/observability/tracing/telemetry.go`:125 (OTLP/gRPC trace exporter, OpenTelemetry Collector)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
- **Question:** What target, credentials, TLS settings, and failure behavior does this client use?
  **Expected signal:** runtime client construction and target configuration
...
- **Question:** Where is this gRPC service registered and which interceptors or credentials apply?
  ...
  **Candidate:** `pkg/epp/server/runserver.go`:231 (ExternalProcessor, pkg/epp/server)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
### http_endpoints

- **Question:** Does this endpoint have additional dynamic routes or a concrete handler/owner?
  **Expected signal:** route registration, handler binding, middleware, or owner symbol
  **Candidate:** `cmd/epp/runner/runner.go`:1112 (/metrics, Unknown, cmd/epp/runner)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
- **Question:** Does this endpoint have additional dynamic routes or a concrete handler/owner?
  **Expected signal:** route registration, handler binding, middleware, or owner symbol
...
- **Question:** Does this endpoint have additional dynamic routes or a concrete handler/owner?
  **Expected signal:** route registration, handler binding, middleware, or owner symbol
  **Candidate:** `pkg/sidecar/proxy/proxy.go`:539 (/, Unknown, pkg/sidecar/proxy)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
### integration_points

- **Question:** What runtime call or protocol realizes this integration?
  **Expected signal:** client construction, request path, protocol, or failure handling
  **Candidate:** `pkg/common/observability/tracing/telemetry.go`:125 (OpenTelemetry Collector, gRPC client)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
...
- **Question:** Where is this internal dependency invoked and what is the interaction boundary?
  **Expected signal:** import, client call, queue, or controller handoff
  **Candidate:** `pkg/epp/server/runserver.go`:231 (Envoy proxy, gRPC ExtProc callout)
  **Status:** candidate; **Limitations:** candidate location only; source inspection is required to establish the relationship
...
- External Processor gRPC methods=gRPC mechanism=None enforcement=N/A policy=Transport TLS is configuration-dependent; no application authentication interceptor is configured [source: pkg/epp/server/runserver.go:231]
- Health gRPC methods=gRPC mechanism=None enforcement=N/A policy=Transport TLS is configuration-dependent; no application authentication interceptor is configured [source: pkg/epp/server/runserver.go:235]
...
- Unknown / on port ; transport=HTTP/1.1 encryption= auth= owner=pkg/sidecar/proxy [source: pkg/sidecar/proxy/proxy.go:539]
- Unknown /metrics on port ; transport=HTTP/1.1 encryption= auth= owner=cmd/epp/runner [source: cmd/epp/runner/runner.go:1112]
### integrations

- OpenTelemetry Collector interaction=gRPC client role=runtime-integration protocol=OTLP/gRPC purpose=Runtime trace export [source: pkg/common/observability/tracing/telemetry.go:125]
### internal_dependencies

- Envoy proxy interaction=gRPC ExtProc callout role=runtime-transport purpose=Receive per-request processing callouts through the Envoy External Processing API [source: pkg/epp/server/runserver.go:231]
...
- **observed**: HTTP Unknown / is owned by pkg/sidecar/proxy [source: pkg/sidecar/proxy/proxy.go:539]
- **observed**: HTTP Unknown /metrics is owned by cmd/epp/runner [source: cmd/epp/runner/runner.go:1112]
### security
...
- **observed**: gRPC External Processor gRPC uses None at N/A; policy=Transport TLS is configuration-dependent; no application authentication interceptor is configured [source: pkg/epp/server/runserver.go:231]
- **observed**: gRPC Health gRPC uses None at N/A; policy=Transport TLS is configuration-dependent; no application authentication interceptor is configured [source: pkg/epp/server/runserver.go:235]
