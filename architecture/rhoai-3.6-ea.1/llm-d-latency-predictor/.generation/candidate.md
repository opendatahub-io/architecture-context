...
The prediction server communicates with the training server over HTTP for model synchronization. This is an intra-component integration: both servers are deployed as part of the same llm-d-latency-predictor system. [source: prediction/prediction_server.py:68, prediction/prediction_server.py:155-179]
