...
- [Run Real Analyzer-Assisted Synthesis on Operator and Dashboard](docs/tasks/current/run-real-analyzer-assisted-synthesis.md) — current (end-to-end skill execution against fresh analyzer artifacts)
