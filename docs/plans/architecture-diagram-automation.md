...
**Date**: March 11, 2026
<<<<<<<< HEAD:docs/plans/000-architecture-diagram-implementation.md
...
**Context Documents**:
- `../notes/architecture-diagram-requirements.md` - Requirements from Slack/Jira/repository analysis
...
>>>>>>>> 9db926c2 (feat: analyzer ownership expansion and v2 design plan (squashed)):docs/plans/architecture-diagram-automation.md
