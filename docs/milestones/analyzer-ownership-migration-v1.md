...
- Residual register: [Analyzer residual agent gaps](../notes/analyzer-residual-agent-gaps.md)
- Prioritization report: [Analyzer remaining candidate prioritization](../notes/analyzer-remaining-candidate-prioritization-2026-07-19.md)
...
- Pending extraction: [Extract Python runtime source surfaces](../tasks/pending/extract-python-runtime-source-surfaces.md)
- Ownership goal: [Analyzer ownership expansion](../goals/analyzer-ownership-expansion.md)
