...
The v1 corpus currently contains 36 questions (Tier 1: 10, Tier 2: 10,
Tier 3: 8, Tier 4: 8). The v1 schema requires `minItems: 40` and
...
This is a pre-existing condition — the 4 missing questions were removed or
