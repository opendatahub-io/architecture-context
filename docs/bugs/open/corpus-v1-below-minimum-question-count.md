...
`benchmark/consumer-v1/corpus.json` contains 37 questions. The v1 contract
...
| 3    | Cross-Component Integration  | 9    | 10   | -1  |
| 4    | Navigation/Structure         | 8    | 10   | -2  |
| **Total** |                         | **37** | **40** | **-3** |

Missing IDs by tier:
- Tier 3 (INTG): INTG-006
...
FAIL: 3 error(s) found:
  ...
  - Tier 3: expected 10 questions, found 9
  - Tier 4: expected 10 questions, found 8
  - Total questions: expected >= 40, found 37
```
...
corpus.json only contains the 37 that survived ground-truth auditing and
subsequent re-authoring. The 3 remaining retired questions were stripped
...
- The existing 37 questions and the v1-ab results are correct and must be
  preserved.

## Resolution Path

Author the 3 missing questions with verified ground-truth answers and
