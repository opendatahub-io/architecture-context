...
`benchmark/consumer-v1/corpus.json` contains 38 questions. The v1 contract
...
FAIL: 2 error(s) found:
  ...
  - Total questions: expected >= 40, found 38
```
...
corpus.json only contains the 38 that survived ground-truth auditing and
subsequent re-authoring. The 2 remaining retired questions were stripped
...
Author the 2 missing questions with verified ground-truth answers and
