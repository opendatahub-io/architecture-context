...
`benchmark/consumer-v1/corpus.json` contains 36 questions. The v1 contract
...
| 3    | Cross-Component Integration  | 8    | 10   | -2  |
| 4    | Navigation/Structure         | 8    | 10   | -2  |
| **Total** |                         | **36** | **40** | **-4** |

Missing IDs by tier:
- Tier 3 (INTG): INTG-003, INTG-006
...
FAIL: 4 error(s) found:
  ...
  - Tier 3: expected 10 questions, found 8
  - Tier 4: expected 10 questions, found 8
  - Total questions: expected >= 40, found 36
```
...
corpus.json only contains the 36 that survived ground-truth auditing and
subsequent re-authoring. The 4 remaining retired questions were stripped
...
- The existing 36 questions and the v1-ab results are correct and must be
  preserved.

## Resolution Path

Author the 4 missing questions with verified ground-truth answers and
